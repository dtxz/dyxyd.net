<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"D:\dyxyd\public/../application/xzadmin\view\auth_group\edit.html";i:1488036844;s:60:"D:\dyxyd\public/../application/xzadmin\view\public\head.html";i:1488038962;s:60:"D:\dyxyd\public/../application/xzadmin\view\public\left.html";i:1488035640;}*/ ?>
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('groupList'); ?>">用户组管理</a>
                    </li>
...
<div class="row">
                            ...
                            <div class="col-sm-6">
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <td>
                                            <label>
                                                <?php echo str_repeat('&nbsp;&nbsp;',$authRule['level']*2); ?>
                                                <input name="rules[]" value="<?php echo $authRule['id']; ?>"
                                                <?php $arr= explode(',',$authgroups['rules']);
                                                   if(in_array($authRule['id'],$arr)){
                                                   echo "checked='checkd'";
                                                   }
                                           ?>
                                                       dataid="<?php echo $authRule['dataid']; ?>"
                                                       class="inverted checkbox-parent <?php if($authRule['level'] != 0): ?> checkbox-child <?php endif; ?>"  type="checkbox" />
                                                <span <?php if($authRule['level'] == 0): ?> style="font-weight:bold; font-size:16px;" <?php endif; ?> class="text"><?php echo $authRule['title']; ?></span>
                                            </label>
                                        </td>
                                    </tr>
    ...
    <script src="__ADMIN__/style/auth.js"></script>
