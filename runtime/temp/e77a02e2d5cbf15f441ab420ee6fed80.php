<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"D:\dyxyd.net\public/../application/xzadmin\view\article\add.html";i:1488179611;s:64:"D:\dyxyd.net\public/../application/xzadmin\view\Public\head.html";i:1488180210;s:64:"D:\dyxyd.net\public/../application/xzadmin\view\Public\left.html";i:1488181315;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('articleList'); ?>">文章管理</a>
                        </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="author" name="author"  type="text" style="width: 150px">
                            </div>
                        </div>
                        <div class="form-group">
