<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\dyxyd.net\public/../application/xzadmin\view\admin\edit.html";i:1488037962;s:64:"D:\dyxyd.net\public/../application/xzadmin\view\Public\head.html";i:1488038962;s:64:"D:\dyxyd.net\public/../application/xzadmin\view\Public\left.html";i:1488035640;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
                                ...
                                <div id="horizontal-form">
                                    <form class="form-horizontal" role="form" action="" method="post">
                                        ...
                                        <div class="form-group">
                                            <label for="username" class="col-sm-2 control-label no-padding-right">管理员所属用户组</label>
                                            <div class="col-sm-6">
                                                <select name="group_id">
                                                    ...
                                                    <option <?php if($authGroupRes['id'] == $groupId): ?>selected="selected"<?php endif; ?>
                                                    value="<?php echo $authGroupRes['id']; ?>"><?php echo $authGroupRes['title']; ?></option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input class="form-control" value="<?php echo $admins['username']; ?>" id="username"  name="username" required="" type="text">
                                            </div>
                                            <p class="help-block col-sm-4 red">* 必填</p>
                                        </div>
