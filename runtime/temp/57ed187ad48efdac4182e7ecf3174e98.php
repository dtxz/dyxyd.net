<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:67:"D:\dyxyd.net\public/../application/xzadmin\view\admin\showlist.html";i:1488037856;s:64:"D:\dyxyd.net\public/../application/xzadmin\view\Public\head.html";i:1488038962;s:64:"D:\dyxyd.net\public/../application/xzadmin\view\Public\left.html";i:1488035640;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
...
<button type="button" tooltip="添加管理员" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('add'); ?>'">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                        <?php if(is_array($result) || $result instanceof \think\Collection): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$admin): $mod = ($i % 2 );++$i;?>
                            <tr>
                ...
                <div style="padding: 5px"><?php echo $result->render();; ?></div>
                <div>
                </div>
            </div>
        </div>
