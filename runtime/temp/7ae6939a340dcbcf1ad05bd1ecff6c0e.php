<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:61:"D:\dyxyd.net\public/../application/xzadmin\view\cate\add.html";i:1488173856;s:64:"D:\dyxyd.net\public/../application/xzadmin\view\Public\head.html";i:1488038962;s:64:"D:\dyxyd.net\public/../application/xzadmin\view\Public\left.html";i:1488120388;}*/ ?>
<!DOCTYPE html>
<html><head>
    <meta charset="utf-8">
            ...
            <div class="page-content">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="<?php echo url('cateList'); ?>">栏目管理</a>
                        </li>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post">
                        <div class="form-group">
                            <label  class="col-sm-2 control-label no-padding-right"> 栏目级别</label>
                            <div class="col-sm-6">
                                <select name="pid">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio">
                                    <label>
                                        <input checked="checked" name="type" value="1" class="incerted" type="radio">
                                        <span class="text">文章列表</span>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input name="type" value="2" class="incerted" type="radio">
                                        <span class="text">单页</span>
                                    </label>
                                </div>
                                <div class="radio">
                                    <label>
                                        <input name="type" value="3" class="incerted" type="radio">
